    ...
    return (
        <div className="flex justify-center items-center">
            <div className="grid grid-cols-3 grid-rows-[auto_1fr] h-[400px] w-[600px] gap-0">
                <div className="col-start-3 row-start-1 p-1 self-start">
                    <img className="w-[200px] h-[170px] object-cover rounded-xl" src="https://placehold.co/100x100" alt="photo4" />
                </div>
                <div className="relative col-start-1 col-span-2 row-start-1 bg-teal-900 pt-3 pl-3 pr-3 text-white rounded-tl-xl rounded-tr-xl z-10">
                    <p className="m-0 text-[14px] leading-relaxed font-medium tracking-wide">
                ...
                <div className="relative row-start-2 col-span-3 bg-teal-900 pl-3 pb-3 pr-3 pt-3 text-white rounded-bl-xl rounded-br-xl rounded-tr-xl -mt-[12px] z-0">
                    <p className="m-0 text-[14px] leading-relaxed font-medium tracking-wide">
